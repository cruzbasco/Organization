class TextType
  def editable (property, value)
    "<div class = 'form-group'><label class='col-md-4 control-label' for='#{property}'> #{property}:</label><div class='col-md-4'><input name='#{property}' type='text' value='#{value}' class='form-control input-md' required=''/></div></div>"
  end
